...
const Profile = () => {
  ...
  // User stats (gamification data — will come from DB in future)
  const userStats = {
    level: 15,
    xp: 3450,
    maxXp: 5000,
          ...
          <TabsContent value="achievements" className="space-y-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
              {achievements.map((achievement) => (
                ...
                >
                  <div
                    className={`absolute inset-0 bg-gradient-to-br ${getRarityGradient(achievement.rarity)}`}
                  />
            ...
            <Card className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-950/20 dark:to-purple-950/20">
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li className="flex gap-2">
                  <CheckCircle2 className="w-4 h-4 text-primary flex-shrink-0 mt-0.5" />
                  <span>
                    Practice with the voice tutor for better communication
                  </span>
                </li>
              </ul>
            </Card>
            ...
            <div className="space-y-4">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex-1 pb-6">
                      <div className="flex items-center justify-between mb-1">
                        <h4 className="font-semibold">
                          Completed Quiz: Accessibility Basics
                        </h4>
                        <span className="text-sm text-muted-foreground">
                          2 hours ago
                        </span>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 pb-6">
                      <div className="flex items-center justify-between mb-1">
                        <h4 className="font-semibold">
                          Started Lesson: Screen Reader Navigation
                        </h4>
                        <span className="text-sm text-muted-foreground">
                          5 hours ago
                        </span>
              ...
              <Card className="p-6">
                ...
                <p className="text-sm text-muted-foreground mt-4">
                  Keep going! You're on a {userStats.streak}-day streak.
                  Complete a lesson today to continue.
                </p>
              </Card>
            </div>
          </TabsContent>
